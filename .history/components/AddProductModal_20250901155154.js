    ...
    <>
      <div className={styles.back}>
        <form className={styles.form} onSubmit={submitHandler}>
          ...
          <input className={styles.input1}  placeholder="نام کالا" />
          <label className={styles.label2}>تعداد موجودی</label>
          <input className={styles.input2} placeholder="تعداد" />
          ...
          <div >
            ...
            <button className={styles.cancell} onClick={()=>setIsOpenModal(false)}>انصراف</button>
          </div>
        </form>
      </div>
    </>
