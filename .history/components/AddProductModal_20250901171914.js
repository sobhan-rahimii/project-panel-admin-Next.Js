    ...
    <>
      <div className={styles.back}>
        <form className={styles.form} onSubmit={submitHandler}>
          ...
          <input value={form.name} className={styles.input1}  placeholder="نام کالا" onChange={(e)=>setForm({...form,name:e.target.value})} />
          <label className={styles.label2}>تعداد موجودی</label>
          <input value={form.qauntity} className={styles.input2} placeholder="تعداد" onChange={(e)=>setForm({...form,quantity:e.target.value})} />
          <label className={styles.lable3}>قیمت</label>
          <input value={form.price} className={styles.input3} placeholder="قیمت" onChange={(e)=>setForm({...form,price:e.target.value})} />
          <div >
