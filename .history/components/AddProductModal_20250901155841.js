    ...
    <>
      <div className={styles.back}>
        <form className={styles.form} onSubmit={submitHandler}>
          ...
          <input value={form.quatity} className={styles.input2} placeholder="تعداد" onChange={(e)=>setForm({...form,quatity:e.target.value})} />
          <label className={styles.lable3}>قیمت</label>
          <input value={form.price} className={styles.input3} placeholder="قیمت" onChange={(e)=>setForm({...form,print:e.target.value})} />
          <div >
